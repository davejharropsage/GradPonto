...
INSERT INTO "new_Activity" ("applicationId", "completedAt", "createdAt", "dueDate", "id", "notes", "subject", "type", "updatedAt", "userId") SELECT "applicationId", "completedAt", "createdAt", "dueDate", "id", "notes", "subject", "type", "updatedAt", "userId" FROM "Activity";
DROP TABLE "Activity";
...
INSERT INTO "new_Application" ("appliedAt", "archived", "createdAt", "deadline", "description", "employerId", "id", "jobUrl", "location", "notes", "priority", "salary", "source", "status", "title", "updatedAt", "userId") SELECT "appliedAt", "archived", "createdAt", "deadline", "description", "employerId", "id", "jobUrl", "location", "notes", "priority", "salary", "source", "status", "title", "updatedAt", "userId" FROM "Application";
...
INSERT INTO "new_Document" ("applicationId", "content", "createdAt", "generatedByAI", "id", "isBase", "kind", "updatedAt", "userId") SELECT "applicationId", "content", "createdAt", "generatedByAI", "id", "isBase", "kind", "updatedAt", "userId" FROM "Document";
DROP TABLE "Document";
...
INSERT INTO "new_Employer" ("createdAt", "id", "industry", "name", "notes", "updatedAt", "userId", "website") SELECT "createdAt", "id", "industry", "name", "notes", "updatedAt", "userId", "website" FROM "Employer";
DROP TABLE "Employer";
...
INSERT INTO "new_Goal" ("createdAt", "endDate", "id", "startDate", "target", "userId") SELECT "createdAt", "endDate", "id", "startDate", "target", "userId" FROM "Goal";
DROP TABLE "Goal";
